        ...
        <div class="row">
            <div class="col-10 col-md-8">
                <div class="image-container">
                    <img src="https://images.stockcake.com/public/0/5/d/05d32c55-2b48-433a-a475-a22124cdbcc9_large/busy-coffee-shop-stockcake.jpg" alt="Coffee Shop" />
                </div>
            </div>
            <div class="col-2 col-md-4 p-5">
                <h1>Admin Login</h1>
...
.image-container img {
    ...
    height: 100%; /* Ensure the image height fills its container */
